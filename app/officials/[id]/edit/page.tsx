...
export default function EditOfficialPage() {
  ...
  const existing = getOfficialById(id)
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-white border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#5e6461]">Edit Official</h2>
              <p className="text-[#5e6461]/70">Update {existing.name}’s profile</p>
            </div>
            <div />
          </div>
        </header>
        ...
        <main className="flex-1 p-6">
          <form onSubmit={onSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-end gap-3">
              <Link href={`/officials/${existing.id}`}>
